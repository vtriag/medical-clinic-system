          ...
          <nav>
            <ul className="flex flex-col px-4 py-4 space-y-4">
              ...
              <li>
                <a
                  href="#signin"
                  className="block px-2 py-2 text-gray-700 transition-colors duration-200 border border-gray-400 rounded hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400"
                  onClick={toggleMenu}
                >
                  Sign In
                </a>
              ...
              <li>
                <a
                  href="#signup"
                  className="block px-2 py-2 text-white transition-colors duration-200 bg-blue-900 rounded shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-950"
                  onClick={toggleMenu}
                >
                  Sign Up
                </a>
