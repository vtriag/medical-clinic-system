...
import Logo from "../assets/images/logo.svg"; // import da imagem da logo

export default function HeaderAtendente({ activePage }) {
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const toggleMenu = () => setIsMenuOpen((s) => !s);

  // Links ajustados para as rotas corretas
  const navLinks = [
    { href: "/relatorios", label: "Relatórios" },
    { href: "/cadastroMedico", label: "Cadastrar Médico" },
    { href: "/cadastroAtendente", label: "Cadastrar Atendente" },
  ];
